...
class Ui_mainWindow(object):
    ...
    def bind(self):
        ...
        self.actionSlow.triggered.connect(self.windows.game.speed_slow)
        self.actionNormal.triggered.connect(self.windows.game.speed_normal)
        self.actionFast.triggered.connect(self.windows.game.speed_fast)
        self.actionEnd_game.triggered.connect(self.windows.game.game_over)
        self.actionNew.triggered.connect(self.windows.game.newGame)
    ...
    def setupUi(self, mainWindow):
        ...
        self.actionEnd_game = QtWidgets.QAction(mainWindow)
        self.actionEnd_game.setObjectName("actionEnd_game")
        self.actionResume_game = QtWidgets.QAction(mainWindow)
        self.actionResume_game.setObjectName("actionResume_game")
        ...
        self.menuOpcje.addAction(self.actionEnd_game)
        self.menuOpcje.addAction(self.actionNew)
    ...
    def retranslateUi(self, mainWindow):
        ...
        self.actionPause.setText(_translate("mainWindow", "Pause game"))
        ...
        self.actionEnd_game.setText(_translate("mainWindow", "End game"))
        self.actionResume_game.setText(_translate("mainWindow", "Resume game"))
