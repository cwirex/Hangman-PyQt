...
class Ui_mainWindow(object):
    def setupUi(self, mainWindow):
        ...
        self.gridLayoutWidget.setGeometry(QtCore.QRect(1310, 120, 281, 171))
        self.gridLayoutWidget.setObjectName("gridLayoutWidget")
        self.grid_score = QtWidgets.QGridLayout(self.gridLayoutWidget)
        self.grid_score.setSizeConstraint(QtWidgets.QLayout.SetDefaultConstraint)
        self.grid_score.setContentsMargins(10, 0, 0, 0)
        self.grid_score.setObjectName("grid_score")
        self.t_score = QtWidgets.QLabel(self.gridLayoutWidget)
        font = QtGui.QFont()
        font.setPointSize(10)
        self.t_score.setFont(font)
        self.t_score.setAlignment(QtCore.Qt.AlignCenter)
        self.t_score.setObjectName("t_score")
        self.grid_score.addWidget(self.t_score, 0, 2, 1, 1)
        self.score_1 = QtWidgets.QLabel(self.gridLayoutWidget)
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        ...
        self.grid_score.addWidget(self.score_1, 1, 2, 1, 1)
        self.player_2 = QtWidgets.QLabel(self.gridLayoutWidget)
        self.player_2.setObjectName("player_2")
        self.grid_score.addWidget(self.player_2, 2, 1, 1, 1)
        self.t_players = QtWidgets.QLabel(self.gridLayoutWidget)
        font = QtGui.QFont()
        font.setPointSize(10)
        self.t_players.setFont(font)
        self.t_players.setObjectName("t_players")
        self.grid_score.addWidget(self.t_players, 0, 1, 1, 1)
        self.score_2 = QtWidgets.QLabel(self.gridLayoutWidget)
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        ...
        self.grid_score.addWidget(self.score_2, 2, 2, 1, 1)
        self.player_1 = QtWidgets.QLabel(self.gridLayoutWidget)
        self.player_1.setObjectName("player_1")
        self.grid_score.addWidget(self.player_1, 1, 1, 1, 1)
        ...
        self.label_current_player.setGeometry(QtCore.QRect(0, 820, 1601, 31))
        font = QtGui.QFont()
        ...
        self.category_your = QtWidgets.QAction(mainWindow)
        self.category_your.setObjectName("category_your")
        ...
        self.menuChoose_category.addAction(self.category_your)
    ...
    def add_player(self):       # Todo
        pass

    def remove_player(self):    # Todo
        pass

    def remove_all(self):       # Todo
        pass

    def update_players(self):   # Todo
        pass
    ...
    def retranslateUi(self, mainWindow):
        ...
        self.score_1.setText(_translate("mainWindow", "0"))
        self.player_2.setText(_translate("mainWindow", "player_2"))
        self.t_players.setText(_translate("mainWindow", "Players"))
        self.score_2.setText(_translate("mainWindow", "0"))
        self.player_1.setText(_translate("mainWindow", "player_1"))
        self.label_current_player.setText(_translate("mainWindow", "player_1"))
        ...
        self.category_your.setText(_translate("mainWindow", "Your category"))
